        ...
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
          ...
          <div className="flex items-center gap-3">
            {token ? (
              <Link
                to="/dashboard"
                className="rounded-lg bg-primary px-4 py-2 text-sm font-semibold transition-colors hover:bg-primary-dark"
              >
                Mi panel
              </Link>
            ) : (
              <>
                <Link
                  to="/login"
                  className="rounded-lg px-4 py-2 text-sm font-semibold text-gray-300 transition-colors hover:text-white"
                >
                  Iniciar sesión
                </Link>
                <Link
